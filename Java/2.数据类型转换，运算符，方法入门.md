...
* 启动Jshell工具，在DOS命令行直接输入JShell命令
  ...
  ![启动jshell](C:\Users\turin\Documents\Github Repositories\Note\Picture\启动jshell.jpg)

* 接下来可以编写Java代码，无需编写类和方法，直接写方法中的代码即可，同时无需编译和运行，直接回车即可

  ![使用jshell](C:\Users\turin\Documents\Github Repositories\Note\Picture\使用jshell.jpg)
...
![变量与常量运算的扩展](C:\Users\turin\Documents\Github Repositories\Note\Picture\变量与常量运算的扩展.jpg)
